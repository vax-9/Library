...
searchButton.addEventListener("click", (e)=>{
    ...
    caricaLibri().then((books)=>(loader.style.display = "none", books.length == 0 ? displayError() : books.forEach((book)=>{
            createCard(book);
        }))).catch((err)=>(loader.style.display = "none", displayError(), console.error("Errore nel caricamento dei libri", err)));
});
...
},{"/src/img/alert.svg":"iRn6N","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iRn6N":[function(require,module,exports) {
